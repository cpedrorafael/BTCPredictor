...
dataset_train = pd.read_csv('BTC_USD.csv', thousands = ',')
...
# Adding the first layer with dropout regularisation
...
# Adding a third layer with dropout regularisation
regressor.add(LSTM(units=50, return_sequences= True))
regressor.add(Dropout(0.2))

# Adding a fourth layer with dropout regularisation
...
# Saving the model
regressor.save("btc_regressor.h5")
...
def load_model ():
    ...
    new_model = load_model("btc_regressor.h5")
    return new_model
